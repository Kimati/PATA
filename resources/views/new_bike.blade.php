...
<head>
	...
	<meta charset="utf-8" content="width=device-width, initia-scale=1.0">
	<script type="text/javascript">
		window.alert('Are you sure you want to sell a bike ?');
	</script>
	<style type="text/css">
		header{
			text-align:center;
...
<body>
    ...
    {!! Form::open(['url'=>'/newbike_store','enctype'=>'multipart/form-data','files'=>true]) !!}

    <div class="form-group">
	{{Form::label('name','Bike Name')}}
	{{Form::text('name', '', ['class' => 'form-control','placeholder'=>'HLX 150X'])}}
