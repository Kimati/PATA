...
<head>
	...
	<script type="text/javascript">
		window.alert('Are you sure you want to sell a phone ?');
	</script>
	<style type="text/css">
		header{
			text-align:center;
...
<body>
    ...
    {!! Form::open(['url'=>'/newphone_store','enctype'=>'multipart/form-data']) !!}

    <div class="form-group">
	{{Form::label('name','Phone Name')}}
	{{Form::text('name', '', ['class' => 'form-control','placeholder'=>'e.g Tecno POP 2F'])}}
   ...
   <div class="form-group">
	...
	{{Form::text('OS', '', ['class' => 'form-control','placeholder'=>'E.g Android...'])}}
	<p style="color:red">@error('OS'){{$message}}@enderror</p> 
   </div>
   <div class="form-group">
...
<nav id="pata_nav_menu">
	...
	<footer>
	<p><small><i>Copyright &copy; 2021 --PATA--@Kenya@</i></small></p>
</footer>
</nav>
</body>
</html>