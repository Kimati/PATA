<?php  
session()->put('reqPhone',$reqphone);
session()->put('prodType',$prodtype);
session()->put('reqPhonName', $reqphonename)
...
<div id="productreq_form">
 ...
 {!! Form::open(['url'=>'/phonereq_store', 'enctype'=>'multipart/form-data']) !!}
