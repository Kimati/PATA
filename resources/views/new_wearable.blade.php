...
<html>
<head>
	<title>Sell a Wearable</title>
	<link rel="stylesheet" type="text/css" href="{{asset('css/pata.css')}}">
	<script type="text/javascript">
		window.alert('Are you sure you want to sell a wearable ?');
	</script>
	<style type="text/css">
		header{
			text-align:center;
...
<body>
	<div id="div1">
		<header>SELL WEARABLE NOW</header>
	...
	{{Form::label('name','Wearable Name')}}
	{{Form::text('name', '', ['class' => 'form-control','placeholder'=>'Smart Watch'])}}
   ...
   <div class="form-group">
	{{Form::label('UPLOAD')}}
	{{Form::file('image',['class' => 'form-control','placeholder'=>'SUBMIT'])}}
