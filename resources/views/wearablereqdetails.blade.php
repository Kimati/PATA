<?php  
session()->put('reqWearableId',$reqwid);
session()->put('reqWearableName',$reqwname);
session()->put('wearableType',$wtype);
...
<div id="productreq_form">
 {!! Form::open(['url'=>'/wearablereq_store', 'enctype'=>'multipart/form-data']) !!}
